...
public class KeyLoader {
    ...
    public KeyLoader() {
        //moduleKeyBindings.add(new ModuleKeyBinding(TNTChina.ESP, new KeyBinding("ESP", TNTChina.ESP.getKey(), "TrueSight"), TrueSightAddon.addon.configuration().getEsp().enabled()));
        //moduleKeyBindings.add(new ModuleKeyBinding(TNTChina.TRUESIGHT, new KeyBinding("TrueSight", TNTChina.TRUESIGHT.getKey(), "TrueSight"), TrueSightAddon.addon.configuration().getTrueSight().enabled()));
